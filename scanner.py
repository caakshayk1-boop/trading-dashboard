...
FNO_ELIGIBLE = {
    ...
    "JSWSTEEL","TATASTEEL","ADANIPORTS","COALINDIA","BPCL","DIVISLAB",
    ...
    "TORNTPOWER","TRIDENT","VEDL","VOLTAS","ADANIGREEN","ADANIPOWER",
...
FALLBACK_NIFTY500 = [
    ...
    "TATASTEEL.NS","ADANIPORTS.NS","COALINDIA.NS","BPCL.NS",
    ...
    "UBL.NS","VBL.NS","VEDL.NS","VOLTAS.NS",
