...
<!-- ══════════ CAREER and LEARNING retired 2026-09-03 ══════════
     Finance Careers, CFO Track, Daily Brief, Smart Reads, Book and Podcasts
     moved to career.askakshay.com, which is built for the job search instead
     of bolted onto the Life page. Their rows are gone from SECTION_MAP and
     their ids are recorded in test_page_structure.RETIRED.
     The generators (jobs.py, daily_learning.py, book_deep.py, podcasts.py)
     are deliberately LEFT RUNNING: daily_learning also feeds Language, Father
     and Wisdom, which stay. Do not disable it without tracing every consumer.
-->
